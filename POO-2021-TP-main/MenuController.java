        ...
        do {
            ...
            switch (user_option) {
                ...
                case 4:
                    ...
                    String eq_casa; String eq_fora; EquipaFutebol casa; EquipaFutebol fora;
                    this.ConsultaEquipas(); boolean confirm;
                    do {
                        eq_casa = ClientView.get_String("Equipa a jogar em casa: ");
                        confirm = this.cm.hasEquipa(eq_casa);
                        if(!confirm) {ClientView.warning("Essa equipa nao esta disponivel nos dados guardados!!");}
                    } while(!confirm);
                    do {
                    ...
                    String datefrominput; LocalDate data_do_jogo;
                ...
                case 5:
                    ...
                    switch (escolha_consulta){
                        case 1:
                            ...
                            int trocar_de_equipa; boolean flag;
                            do {
                            ...
                            if(trocar_de_equipa != 2){
                                ...
                                do {
                                    ...
                                    if (this.cm.hasJogador(nome)) {
                                        flag = true; JogadorFutebolView.print_jogador(this.cm.get_jogador(nome));
