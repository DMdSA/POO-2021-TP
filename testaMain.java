...
import Jogadores.Avancado;
import Jogadores.JogadorFutebol;
import Jogadores.Lateral;
...
public class testaMain {
    ...
    public static void main(String[] args){
        ...
        JogadorFutebol j1 = new Avancado("Diogo", 20, 145, 75.3, PosicaoCampo.A, 7, 12.2, 5.5, 2.2, 8, 3, 5, 1, 7, historico1, 11);
        ...
        JogadorFutebol j10 = new Lateral ("Quim", 20, 184, 72.0, PosicaoCampo.D, 9, 2.2, 11.1, 2.99, 13, 3,8, 2.1, 1, historico10, 13);
        ...
        EquipaFutebol ef1 = new EquipaFutebol("Equipa_Teste", Cor.VERMELHO, Cor.ROSA);
