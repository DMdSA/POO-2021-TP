...
public class testaMain {
    ...
    public static void main(String[] args) throws IOException {
        ...
        */
        ...
        //LogParse leitura = new LogParse();
        //leitura.Parse("logs.txt");
        //System.out.println("\n#> Oizao");

        FileWriter filefp = new FileWriter("diogo.txt", true);
        BufferedWriter fich = new BufferedWriter(filefp);
       fich.write("E quero chorar AHAHAHAH");
        fich.flush();
        fich.close();
    }
}